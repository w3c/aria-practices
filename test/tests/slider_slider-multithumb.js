...
const ex = {
  ...
  hotelLabelSelector: '#ex1 .slider-multithumb:nth-of-type(1) [role="slider"] .slider-value',
  flightLabelSelector: '#ex1 .slider-multithumb:nth-of-type(2) [role="slider"] .slider-value',
};
...
ariaTest(
  ...
  'slider-role',
  async (t) => {
    await assertAriaRoles(t, 'ex1', 'slider', '4', 'div');
  }
);

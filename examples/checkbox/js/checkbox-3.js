...
function updateGroupCheckbox (event) {
  ...
  var groupCheckbox = node.parentNode.parentNode.getElementsByClassName('groupCheckbox')[0];
  var image = groupCheckbox.getElementsByTagName('img')[0];

  groupCheckbox.setAttribute('aria-checked', state);
  ...
  if (state === 'false') {
    ...
    image.src = './images/checkbox-mixed-black.png';
  }
}
/*

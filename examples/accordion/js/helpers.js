...
if (!l || !l.length){
if (t === '*' && r.all) l = r.all;
else if (r.all && r.all.tags) l = r.all.tags(t);
}
return l;
},
...
if (arguments[4]) o.appendChild(createText(arguments[4]));
return o;
},
...
if (!f) return s;
if (nextSib(f)) f.parentNode.insertBefore(s, nextSib(f));

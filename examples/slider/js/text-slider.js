 ...
 */
 ...
 var TSlider = function (domNode)  {
    ...
    //Create TSlider that contains value, valuemin, valuemax, and valuenow
...
TSlider.prototype.handleMouseDown = function (event) {
    ...
    var handleMouseMove = function(event) {
      ...
      var diffX = event.pageX - slider.railDomNode.offsetLeft;
      slider.valueNow = parseInt(((slider.valueMax - slider.valueMin) * diffX) / slider.railWidth);
      slider.moveTSliderTo(slider.valueNow);

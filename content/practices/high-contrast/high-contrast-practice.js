...
const systemColorValues = [
  {value: 'AccentColor', name: 'Accent color', desc: 'Background of accented user interface controls'},
  {value: 'AccentColorText', name: 'Accent color text', desc: 'Text of accented user interface controls'},
  {value: 'ActiveText', name: 'Active text',   desc: 'Text of active links'},
  {value: 'ButtonBorder', name: 'Button border', desc: 'Base border color of controls'},
  {value: 'ButtonFace', name: 'Button face', desc: 'Background color of controls'},
  {value: 'ButtonText', name: 'Button text', desc: 'Text color of controls'},
  {value: 'Canvas', name: 'Canvas', desc: 'Background of application content or documents'},
  {value: 'CanvasText', name: 'Canvas text', desc: 'Text color in application content or documents'},
  {value: 'Field', name: 'Field', desc: 'Background of input fields'},
  {value: 'FieldText', name: 'Field text', desc: 'Text in input fields'},
  {value: 'GrayText', name: 'Gray text', desc: 'Text color for disabled items (e.g. a disabled control)'},
  {value: 'Highlight', name: 'Highlight', desc: 'Background of selected items'},
  {value: 'HighlightText', name: 'Highlight text', desc: 'Text color of selected items'},
  {value: 'LinkText', name: 'Link text', desc: 'Text of non-active, non-visited links'},
  {value: 'Mark', name: 'Mark', desc: 'Background of text that has been specially marked (such as by the HTML mark element)'},
  {value: 'MarkText', name: 'Mark text', desc: 'Text that has been specially marked (such as by the HTML mark element)'},
  {value: 'SelectedItem', name: 'Selected item', desc: 'Background of selected items, for example, a selected checkbox'},
  {value: 'SelectedItemText', name: 'Selected item text', desc: 'Text of selected items'},
  {value: 'VisitedText', name: 'Visited text', desc: 'Text of visited links'}
];
